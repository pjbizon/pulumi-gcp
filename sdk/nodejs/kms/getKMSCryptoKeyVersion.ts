 ...
 * 
 * const myCryptoKeyVersion = google_kms_key_my_key.selfLink.apply(selfLink => gcp.KmsCryptoKeyVersion({
 *     cryptoKey: selfLink,
 * }));
...
export interface GetKMSCryptoKeyVersionArgs {
    ...
    readonly publicKey?: inputApi.kms.GetKMSCryptoKeyVersionPublicKey;
    /**
...
export interface GetKMSCryptoKeyVersionResult {
     ...
     */
    readonly publicKey?: outputApi.kms.GetKMSCryptoKeyVersionPublicKey;
    /**
